...
def bmp_to_tar(bmp_path, tar_path):
    ...
    quaternary_str = ''.join(pixel_to_quaternary(pixel) for pixel in pixels if pixel_to_quaternary(pixel) != '4')  # 忽略黑色像素
...
if __name__ == '__main__':
    bmp_to_tar('example-origin.bmp', 'recovered_example22.tar')